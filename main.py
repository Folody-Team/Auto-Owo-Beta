...
async def help(ctx):
    embed = discord.Embed(
        title="<a:754014796587991292:860768649316663297> Help AutoOwO <a:754014796587991292:860768649316663297>",
        color=435436,
        description=
        f"<a:TadaBig:852071183762718741>**{prefix}autoOwO**\nowoh, owo sell all, owo flip 500 and owo cash 50 seconds.\n\n**<a:TadaBig:852071183762718741>{prefix}stopautoOwO**\nstops autoOwO.\n\n**<a:TadaBig:852071183762718741>{prefix}banbypass**\nIts prevent you from banning Owo by taking appropriate time\n Example:-`the bot takes breaak 5 min of runnning 1st break= 5min,2nd break=10min 3rd break=15min` \n\n Made by [RogmitOp](https://www.youtube.com/channel/UCPJRB-I9FCkWzgN3c2vKIpQ) | [Support](https://discord.gg/MhatB2Qx)"
    )
    embed.set_thumbnail(
        url=
        "https://images-ext-2.discordapp.net/external/3CBRdDbc7fTlFA15zUA2ZCEJxMJyNadwtf6jrEtC-WE/%3Fwidth%3D450%26height%3D338/https/media.discordapp.net/attachments/860570956258607124/862329533004251176/ezgif.com-gif-maker.gif?width=338&height=254"
    )
...
Invite Folody Bot and Tuấn's Music bot
https://folody.tk

--> Bot is running on host 1.1.1.1;port 80
